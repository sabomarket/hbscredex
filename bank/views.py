...
def transaction_history( request):
    ...
    if request.method == 'POST':
        new_vet = Transfer()
        new_vet.date = request.POST.get("date")
        new_vet.accountnumber = request.POST.get("accountnumber")
        new_vet.bank_email = request.POST.get("bank")
        new_vet.name = request.POST.get("name")
        new_vet.amount = request.POST.get("amount")
        new_vet.charge = request.POST.get("charge")
        new_vet.type = request.POST.get("type")
        new_vet.status = request.POST.get("status")
